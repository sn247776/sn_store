...
class SnSearchContainer extends StatelessWidget {
  const SnSearchContainer({super.key, required this.text, this.icon = Iconsax.search_normal,  this.showBackground = true,  this.showBorder = true});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(padding: const EdgeInsets.symmetric(horizontal: SnSizes.defaultSpace),
    child: Container(
