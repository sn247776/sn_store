...
import 'package:sn_store/features/shop/screens/cart/cart.dart';
      ...
      children: [
        ...
        Positioned(
            ...
            child: Container(
              ...
              child: Center(
                child: Text('2', style: Theme.of(context).textTheme.labelLarge!.apply(color: SnColors.white, fontSizeFactor: 0.8),),
              ),
            ))
      ],
    );
